...
async function main() {
  ...
  await prisma.participant.create({
    data: {
      userId: user1.id,
      tripId: trip1.id,
      profilePublicInfo: 'Organizador da viagem, fã de rock há 15 anos!',
    },
  });
  ...
  await prisma.participant.create({
    data: {
      userId: user2.id,
      tripId: trip1.id,
      profilePublicInfo: 'Primeira vez no Rock in Rio, muito animada!',
    },
  });
  ...
  await prisma.participant.create({
    data: {
      userId: user3.id,
      tripId: trip1.id,
      profilePublicInfo: 'Metaleiro desde sempre, vamos que vamos!',
    },
  });
  ...
  await prisma.participant.create({
    data: {
      userId: user2.id,
      tripId: trip2.id,
      profilePublicInfo: 'Organizando a melhor trip para o Lolla!',
    },
  });
  ...
  await prisma.participant.create({
    data: {
      userId: user3.id,
      tripId: trip2.id,
      profilePublicInfo: 'Indie rock lover, primeira vez no Lollapalooza!',
    },
  });

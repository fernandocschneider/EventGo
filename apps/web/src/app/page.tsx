          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/trips/create">
              <Button
                size="lg"
                variant="outline"
                className="border-white text-purple-600 hover:text-purple-600 hover:bg-gray-100 px-8 py-4 text-lg font-semibold transition-smooth"
              >

...
const GET_EVENTS_AND_TRIPS = gql`
  query GetEventsAndTrips($eventLimit: Int, $tripLimit: Int, $eventFilter: EventsFilter) {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-yellow-400">para eventos incríveis</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-blue-100">
              Conecte-se com pessoas, divida custos e aproveite shows, festivais e eventos com segurança e praticidade.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              A maneira mais fácil e segura de organizar viagens em grupo para seus eventos favoritos
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {data?.events?.map((event: any) => (
                <Card key={event.id} className="card-hover cursor-pointer bg-white border-0 shadow-md">
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="flex items-center text-sm text-gray-500">
                          ...
                          {event.trips?.reduce((acc: number, trip: any) => acc + trip.totalParticipants, 0) || 0}
                        </div>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="bg-gray-50 rounded-xl p-6 loading-pulse">
                  <div className="h-4 bg-gray-200 rounded mb-4"></div>
                  <div className="h-3 bg-gray-200 rounded mb-2"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {data?.trips?.map((trip: any) => (
                <Card key={trip.id} className="card-hover cursor-pointer bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-100">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Junte-se a milhares de pessoas que já organizam suas viagens com segurança e praticidade
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signup">
